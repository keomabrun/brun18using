...
\begin{abstract}
Two low-power wireless networks of sensors deployed, one in a peach orchard, one in an office building.
Both network use SmartMesh technology to gather sensor values and network statistics, and connect to a back-end system.
This paper presents an in-depth analysis of the performance of the network.
...
\begin{figure}
    \centering
    \includegraphics[width=0.80\textwidth]{orchard}
