...
Thanks to the use of Time Slotted Channel Hopping (TSCH), the network topology is very stable, with $\leq$5 link changes on average per day in the entire network.
\end{abstract}
...
\begin{itemize}
    ...
    \item We show that channel hopping causes the network topology to be very stable, with $\leq$5 link changes on average per day;
