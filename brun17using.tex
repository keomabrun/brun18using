...
\address[utn]{~Univ. Tecnol\'ogica Nacional (UTN), Mendoza, Argentina}
...
Fighting the frost event is not the issue, what is hard is predicting it.
...
It is deployed in a typical 5-story office building, in which semi-permanent walls separate offices which are arranged around a concrete core which houses the elevators.
...
For the \agri deployment, the PDR of the link is very good~($>95$\%) above $-85~dBm$.
...
This is expected, as this mote relays lots of data.
...
\begin{subtable}{.5\textwidth}
    \begin{tabular}{|c|c|r|}
        ...
        MAC           &  charge  & lifetime \\
                      & consumed$^\star$ &          \\
        \midrule
        \tt{30-60-ef} &  695 KC  &  3 years \\
        \tt{38-0f-66} &  461 KC  &  5 years \\
        \tt{3f-f8-20} &  380 KC  &  6 years \\
        \tt{3f-fe-87} &  549 KC  &  4 years \\
        \tt{3f-fe-88} &  718 KC  &  3 years \\
        \tt{58-32-36} &  311 KC  &  6 years \\
        \tt{60-01-f8} &  387 KC  &  6 years \\
        \tt{60-02-1b} &  371 KC  &  6 years \\
        \tt{60-02-4b} &  406 KC  &  6 years \\
        \tt{60-03-82} &  395 KC  &  6 years \\
        \tt{60-05-5f} &  386 KC  &  6 years \\
        \tt{60-05-69} &  509 KC  &  5 years \\
        \tt{60-05-78} &  364 KC  &  6 years \\
        \tt{60-05-ab} &  381 KC  &  6 years \\
        \tt{60-06-27} &  422 KC  &  5 years \\
        \tt{60-08-d5} &  432 KC  &  5 years \\
        \bottomrule
    \end{tabular}
    \caption{\agri}
\end{subtable}\hfill
...
\end{subtable}\hfill
\vspace{2mm}
$^\star$~over the \thomas{period?} period.
...
Because the network uses channel hopping, these reported RSSI values are also averaged over 15~IEEE802.15.4 frequencies~\cite{std_ieee802154_2015}.
