...
Communication is done on the 2.4~GHz range, with channel hopping happening on 15 frequencies, between 2.405~GHz and 2.475~GHz.
...
Several wireless technologies operate in the same building on the same 2.4~GHz frequency band, including WiFi, Bluetooth and other IEEE802.15.4-based networks.
...
\end{subtable}\hfill
\vspace{2mm}
$^\star$~over the 20 Jun. 2016 - 5 Oct. 2016 period (107 days).\\
$^{\star\star}$~over the 13 Nov. 2016 - 9 Feb. 2017 period (88 days).
