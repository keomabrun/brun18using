...
More information can be found on the manufacturer documentation\ref{smip_app_note}.
...
It features over-the-air reprogramming and periodically send network statistic when using the default application (which we do).
...
Felipe Moran for his preciously help in the interference analysis.
