...
One example is frost prediction, as the analysis of sensor data triggers an warnings that goes to the farmer about the imminence of a frost event.
...
For example, \smip operates in the same 2.4~GHz band as Wi-Fi and Bluetooth.
...
With over 60,000 networks deployed around the world, and the market leader position, \smip is a proven technology.
